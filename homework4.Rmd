...
&\Rightarrow P(A_i|B)=\frac{P(B|A_j)P(A_i)}{\sum_j(B|A_j)P(A_j)}
\end{aligned}$$

###Watch your subscripts, you missed one! I fixed it above, just keep an eye out, for super complex LaTex, things like that can get messy!
