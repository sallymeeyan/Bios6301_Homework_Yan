...
(-1) See comment at end of question.
...
(-3) It looks to me like you just input the number of visits for each id, rather than `1:n` for each visit, e.g. for someone with 4 visits, the visit variable would be `[1,2,3,4]` for each visit.
...
It looks like you forgot to account for when there is a 2+ year gap in observations. This meant some of your counts are wrong (like id 15 and 16), and it leads you to leave off a row when printing the observations for 15. Let me know if you want help with this!
...
This is an excellent explanation -- thanks for being so thorough!
